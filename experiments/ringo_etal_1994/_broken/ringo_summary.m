...
dirs_d2_nonoise  = dir(fullfile(guru_getOutPath('cache'), [prefix '-*ts-2d']));
dirs_d10_nonoise = dir(fullfile(guru_getOutPath('cache'), [prefix '-*ts-10d']));
dirs_d2_noise    = dir(fullfile(guru_getOutPath('cache'), [prefix '-*ts-2dn']));
