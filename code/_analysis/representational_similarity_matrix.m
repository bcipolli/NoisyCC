...
% pat_idx : pattern indices
    ...
    keyboard
    rh_in =  squeeze(pats.train.P(2,:,2:6)); % avoid the bias term
    lh_in =  squeeze(pats.train.P(2,:,7:11));
    rh_out =  squeeze(pats.train.d(1,:,1:5));
    lh_out =  squeeze(pats.train.d(1,:,6:10));
