...
%
    ...
    guru_assert(net.ncc < net.nhidden/4, 'Ringo model only connects early and late hidden units with intrahemispheric-only connections... and you have none!');
    ...
    net.cC(net.idx.lh_early_ih,net.idx.lh_late_ih) = true;    %early->late hidden % ih only.
