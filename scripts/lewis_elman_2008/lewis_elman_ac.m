...
net.sets.T_INIT          = [0.005 0.005];  %change     
...
net.sets.lambda_w        = 2E-4;    % lambda*E to control kappa. 
...
net.sets.ac.duplicate_output = true; % :( :( :(
net.sets.ac.noise_init       = 0;%1;
net.sets.ac.noise_input      = 0;%001;%1;

net.sets.ac.train_criterion = 0.5;
net.sets.ac.eta_w           = 1E-2;%7E-3;
net.sets.ac.lambda_w        = 2E-3;%1E-3;
net.sets.ac.phi_w           = 0.15;
net.sets.ac.alpha_w         = 0.15;
