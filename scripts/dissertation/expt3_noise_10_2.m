...
noise_schedule = [linspace(1, 1, 500) linspace(1,0.0,500) 0*linspace(0.1,0.0,1000) ];  % relative schedule of noise.

net = dissertation_args();
net.sets.niters = 2000;  guru_assert(net.sets.niters == length(noise_schedule));
