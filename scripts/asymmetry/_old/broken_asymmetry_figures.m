...
%% Preliminary tests
% Noise vs. no-noise
ringo_figures(fullfile(evo_cache,'asymmetric_symmetric_nonoise.15'), fullfile(evo_cache,'asymmetric_symmetric_noise.15'), [0.3 0.4]);
[~,~,oh] = legend();
...
%
for fignum=[0.3 0.4]
    ringo_figures(fullfile(evo_cache,'asymmetric_symmetric_nonoise.15'), fullfile(evo_cache,'symmetric_asymmetric_nonoise.15'), fignum);
    [~,~,oh] = legend();
